...
} SIBhash_context_holder;

SIBhash_context_holder base_contexts;

void init_SIBhash_contexts()
{
...
void SIBhash(void *state, const void *input)
{   
    SIBhash_context_holder ctx;
	
    uint32_t hashA[16], hashB[16];	
    //blake-bmw-groestl-sken-jh-meccak-gost-luffa-cubehash-shivite-simd-echo
